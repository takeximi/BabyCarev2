 ...
 * @author ACER
 */
@WebServlet(name="StatusBookingServlet2", urlPatterns={"/StatusBookingServlet2"})
public class StatusBookingServlet2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        if (bookingIDStr != null && bookingStatusStr != null) {
            ...
            response.sendRedirect("ListConfirmedServices");
        } else {
