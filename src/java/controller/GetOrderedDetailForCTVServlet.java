...
@WebServlet(name = "GetOrderedDetailForEmpServlet", value = "/getordereddetailctv")
public class GetOrderedDetailForCTVServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        User user =OrderRepository.getUserByBillID(orderId);
