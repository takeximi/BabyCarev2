 ...
 * @author ACER
 */
@WebServlet(name="DeleteBillBookingServlet", urlPatterns={"/DeleteBillBookingServlet"})
public class DeleteBillBookingServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("deleteBill.jsp");
    }
