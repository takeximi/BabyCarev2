...
<div class="container-fluid pt-5 ">
    ...
    <div id="page-wrapper">
        ...
        <nav class="nav nav-pills nav-justified">
            <a class="nav-item nav-link text-white " href="manage-emp-account">Danh sách tài khoản nhân viên</a>
            <a class="nav-item nav-link text-white" href="#">Thêm tài khoản nhân viên</a>
                                ...
                                <div class="col-md-6 offset-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="username" placeholder="Username"
                                               name="username"
                                               aria-describedby="inputGroupPrepend" pattern="^[a-zA-Z][a-zA-Z0-9]{6,20}$"
                                               required>
                                        <div class="invalid-feedback">
                                            Username bắt đầu bằng chữ cái và từ 6 đến 20 kí tự không chứa kí tự đặc biệt
                                        </div>
                                    </div>
                                </div>
