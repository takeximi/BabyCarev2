                ...
                <div class="w-50 border-top pt-2 mt-3 d-flex justify-content-between">
                    ...
                    <c:if test="${orderedCart.discountCode != null}">
                        <strong style="font-size: x-large;">
                            ...
                            ${orderedCart.calculateTotalPriceStringWithDiscount(orderId, totalShippingFee)}
                        </strong>
                    </c:if>
                </div>
            </div>
            <div class="border-top pt-3 col-md-4 kt-right">
                <div>
                    <c:if test="${orderStatus.equals('Đang xử lý-CK')}">
                        <img width="90%"
                             src="https://img.vietqr.io/image/BIDV-5660479367-print.png?amount=${totalPriceAll}&addInfo=Thanh toan hoa don ${orderId}&accountName=Đặng Phương Nam"
                             alt="">
                    </c:if>
                </div>
            </div>
